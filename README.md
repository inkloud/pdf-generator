...
```bash
docker build -t bacchilu/pdf-generator -t bacchilu/pdf-generator:4.4.2 --build-arg USER_ID=`id -u` --build-arg GROUP_ID=`id -g` .
docker push bacchilu/pdf-generator
docker push bacchilu/pdf-generator:4.4.2
